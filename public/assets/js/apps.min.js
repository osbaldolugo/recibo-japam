...
var handleSlimScroll = function () {
    ...
    if (!$(e).attr("data-init")) {
        var a = $(e).attr("data-height"), t = {height: a = a || $(e).height(), alwaysVisible: !0};
    ...
    function e(e, a) {
        ...
        var t = $(e).width(), i = $(e).find("li.active").width(), n = a > -1 ? a : 150, o = 0;
    ...
    function a(e, a) {
        ...
        switch ($(t).find("li").each(function () {
            ...
            case"prev":
                var l = -i;
                l <= n ? ($(t).removeClass("overflow-left"), s = 0) : s = l - n + 80, $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, 150, function () {
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function (a) {
        ...
        } else parseInt(e) >= 0 || o >= s ? $(t).animate({marginTop: "0px"}) : (l = e, $(t).animate({marginTop: l + "px"}))
    })
    ...
    function e(e, a) {
        ...
        switch ($(t).find("li").each(function () {
            ...
            case"prev":
                var l = -i;
                l <= n ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), s = 0) : s = l - n + 88, $(t).animate({marginLeft: "-" + s + "px"}, 150, function () {
    ...
    function a() {
        var e = $(".top-menu .nav"), a = $(".top-menu .nav > li"), t = $(".top-menu .nav > li.active"), i = $(".top-menu"), n = (parseInt($(e).css("margin-left")), $(i).width() - 128), o = $(".top-menu .nav > li.active").width(), s = 0;
