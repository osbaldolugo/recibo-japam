...
class PMOEquipmentDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'p_m_o_equipments.datatables_actions')
            ->make(true);
    }
    ...
    {
        $pMOEquipments = PMOEquipment::query();

        return $this->applyScopes($pMOEquipments);
    }
