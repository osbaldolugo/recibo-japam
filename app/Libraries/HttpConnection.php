...
ini_set('max_execution_time', 180); //   va a alargar el timeout por default en la conf de php , ya que aveces sicagua , tarda bastante
use Exception;
/**
...
class HttpConnection
{
    ...
    public function get($url, $follow = false)
    {
            ...
            if ($result === false) 
            {
                throw new Exception(curl_error($this->curl), 503);
            }
            $this->_close();
