...
class AgentsController extends Controller
{
    public function index()
    {
        ...
        return view('kordy.admin.agent.index', compact('agents'));
    }
    ...
    public function create()
    {
        ...
        return view('kordy.admin.agent.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('AgentsController@index');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->action('AgentsController@index');
    }
