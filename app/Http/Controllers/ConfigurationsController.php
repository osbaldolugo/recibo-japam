...
class ConfigurationsController extends Controller
{
  ...
  public function index()
  {
    ...
    foreach ($configurations as $config_item) {
      ...
      return view('kordy.admin.configuration.index', compact('configurations', 'configurations_by_sections'));
  }
  ...
  {
      return view('kordy.admin.configuration.create');
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('ConfigurationsController@index');
  }
  ...
  public function edit($id)
  {
      ...
      return view('kordy.admin.configuration.edit', compact('configuration', 'should_serialize', 'default_serialized'));
  }
