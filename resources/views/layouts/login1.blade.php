...
<!-- ================== END BASE JS ================== -->
    ...
    margin: auto;
    margin-top: 14%;
    box-shadow: #0000008a 0 0 13px, #00000069 0 0 43px;
    }
    </style>
</head>
...
<div id="page-container" class="fade">
    <!-- begin login -->
    <div class="login login-with-news-feed" style= "background: #0f3b60;    height: 100%;">
        <!-- begin news-feed -->
        <!--
        <div class="news-feed">
            <div id="c-slider">
                <div id="slider">
                    <section><img src="{{url('img/email/slider/slider1.jpg')}}" alt=""></section>
                    <section><img src="{{url('img/email/slider/slider2.jpg')}}" alt=""></section>
                    <section><img src="{{url('img/email/slider/slider3.jpg')}}" alt=""></section>
                    <section><img src="{{url('img/email/slider/slider7.jpg')}}" alt=""></section>
            ...
            <div class="news-image">
                <img src="{{URL::to('img/login11.png')}}" data-id="login-cover-image" alt="Background-image" />
            </div>
