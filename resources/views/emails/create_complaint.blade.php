                                                                ...
                                                                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            <center>
                                                                                <h3>TE INFORMAMOS QUÉ</h3>
                                                                                <br/>
                                                                                Se ha generado <b>{!! $type_string !!}</b>
                                                                                ...
                                                                                @if(isset($phone_number))
                                                                                    <strong>TELÉFONO:</strong>&nbsp;{!! $phone_number !!}
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($address))
                                                                                ...
                                                                                @if(isset($report_type))
                                                                                    <strong>TIPO DE REPORTE:</strong>&nbsp;{!! $report_type !!}
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($contract))
                                                                                ...
                                                                                @endif
                                                                                @if(isset($meter))
                                                                                    <strong>MEDIDOR:</strong>&nbsp;{!! $meter !!}
                                                                                    <br/>
                                                                                @endif
                                                                                <br/>
                                                                                <strong>{!! strtoupper($type) !!}:</strong><br/>{!! $complaint !!}
                                                                                <br/>
                                                                            </center>
                                                                        </td>
                                                                    </tr>
