                                                                        ...
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            <div id="loginNormal">
                                                                                <div style="text-align: center;">
                                                                                    Te informamos que se ha generado una {{$title}} desde <b>Japam Móvil</b> con la siguiente información:
                                                                                </div><br>
                                                                                <div style="text-align:center">
                                                                                    <strong>Usuario</strong>:
                                                                                    <br/><a style="text-decoration:none;  color: #202020">{!! $name !!}</a>
                                                                                    <br>
                                                                                    <strong> Número de teléfono:</strong><br/> {!! $phone_number !!}
                                                                                    <br>
                                                                                    <strong> {!! $type !!}:</strong><br/> {!! $description !!}
                                                                                    <br>
                                                                                    <div style="text-align: center;">
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div style="text-align: center;">
                                                                                <br><img src="{{url('img/logo_japam_vive.png')}}" style="width:150px; margin-top: 10px;">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
