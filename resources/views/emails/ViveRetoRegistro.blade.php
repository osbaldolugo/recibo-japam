                                                                                                    ...
                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                                                                        <tbody><tr>
                                                                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                                                                <center>
                                                                                                                    <h1>¡LISTO!</h1>
                                                                                                                    <h2>TE HAS AFILIADO AL NUEVO RECIBO DIGITAL</h2>
                                                                                                                </center>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        </tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                                                                <center>
                                                                                                                    ...
                                                                                                                    <br/>
                                                                                                                    <br/><i style="font-size: small">*Ahora ya puedes registrar y vincular recibos a esta cuenta de correo electrónico,
                                                                                                                    <br/>desde el Portal Web ó la app de JAPAM Móvil.</i>
                                                                                                                </center>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        </tbody>
                                                                                        ...
                                                                                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                                            <tbody><tr>
                                                                                                <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                                    <img align="center" alt="" src="{{ url('img/email/japam_banner_nuevo.jpeg') }}" width="600" style="max-width:600px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage blockDropTarget" id="dijit__Templated_5" widgetid="dijit__Templated_5">
                                                                                                </td>
                                                                                            </tr>
                                                                                            </tbody>
                                                                                        </table>
