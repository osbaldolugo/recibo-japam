                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding:9px" class="mcnImageBlockInner">
                                                                            <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                                <tbody><tr>
                                                                                    <td class="mcnImageContent mcnTextContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                        <img align="center" alt="" src="{{URL::to('img/email/logo.png')}}" style="max-width:150px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage blockDropTarget" id="dijit__Templated_0" widgetid="dijit__Templated_0">
                                                                                        <br>
                                                                ...
                                                                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            <div id="loginNormal">
                                                                                <div style="text-align: center; font-size: 15px !important; font-weight: bold; text-transform: uppercase;">
                                                                                    Detalles de pago
                                                                                    <br>
                                                                                    <h5 style="font-size: 10px;color: #847878;">{{$payDate}}</h5>
                                                                                </div>
                                                                                <table style="width:100%;">
                                                                                    <tbody>
                                                                                    <tr style="font-size: 13px;">
                                                                                        <td width="50%" style="text-align: left">Transacción: <br>{{$transaction}}</td>
                                                                                        <td width="50%" style="text-align: right">Autorización:<br> {{$authorization}}</td>
                                                                                    </tr>

                                                                                    <tr style="text-align:left;width:100%;padding:0" align="left">
                                                                                        <td width="65%"  style="border-collapse:collapse!important;text-align:left;color:#333;" align="left" valign="top">
                                                                                        ...
                                                                                        <td  valign="middle" width="35%" style="text-align:right;white-space:nowrap;font-size:19px;font-weight:bold;" align="right" valign="top" >
                                                                                            ${!! $amount !!}MXN
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody></table>
                                                                                                    ...
                                                                                                    <table style="height: 9.5rem;!important;">
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td style="padding-left: 11.5rem!important; padding-top: 0.3rem!important;">
                                                                                                                @if($cardType == 'VISA')
                                                                                                                    <img src="{{url('img/cards/visa.png')}}" style="width:35px; ">
                                                                                                                @else
                                                                                                                    <img src="{{url('img/cards/mastercard.png')}}" style="width:35px;">
                                                                                                                @endif
                                                                                                            </td>
                                                                                                        </tr><tr>
                                                                                                            <td style="text-align: left; padding-left: 1rem;padding-top: 0rem;">
                                                                                                                <img src="{{url('img/cards/chip.png')}}" style="width:35px;">
                                                                                                            </td>
