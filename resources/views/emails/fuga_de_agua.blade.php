                                                                            ...
                                                                            <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                                <tbody><tr>
                                                                                    <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                        <img align="center" alt="" src="{{ url('img/logo_japam_movil.png') }}" style="max-width:400px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage blockDropTarget" id="dijit__Templated_0" widgetid="dijit__Templated_0">
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                                                ...
                                                                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                            <center>
                                                                                <h3>TE INFORMAMOS QUE</h3>
                                                                                <br/>
                                                                               
                                                                                Se ha generado un reporte por <b>{!! $tipo_de_reporte !!}</b>
                                                                                <br/>desde <b>JAPAM Móvil</b> con la siguiente información:
                                                                                <br/>
                                                                                <br/>
                                                                                @if(isset($nombre_completo))
                                                                                    NOMBRE:<strong> {!! $nombre_completo !!}</strong>&nbsp;
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($telefono))
                                                                                ...
                                                                                @if(isset($direccion))
                                                                                    ...
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($tipo_de_reporte))
                                                                                    TIPO DE REPORTE:<strong> {!! $tipo_de_reporte !!}</strong>&nbsp;
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($numero_de_contrato))
                                                                                    CONTRATO:<strong> {!! $numero_de_contrato !!}</strong>&nbsp;
                                                                                    <br/>
                                                                                @endif
                                                                                @if(isset($medidor))
                                                                                    MEDIDOR:<strong> {!! $medidor !!}</strong>&nbsp;
                                                                                    <br/>
                                                                                @endif
                                                                                <br/>
                                                                                <strong>{!! $tipo_de_reporte !!}:</strong><br/>{!! $descripcion !!}
                                                                                <br/>
                                                                            </center>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                                <tbody><tr>
                                                                                    <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                        <img align="center" alt="" src="{{ url('img/footer.png') }}" width="600" style="max-width:600px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage blockDropTarget" id="dijit__Templated_5" widgetid="dijit__Templated_5">
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
