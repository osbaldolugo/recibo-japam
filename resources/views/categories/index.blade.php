    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h2 class="panel-title">
                <i class="ion-grid"></i>
                Catálogo de Areas
                <a class="btn btn-primary pull-right" style="margin-top: -6px" id="createCategory" data-route="{{ route("categories.store") }}">
                    <i class="fa fa-plus-square"></i>&nbsp;Agregar Nueva Area
                </a>
            </h2>
        </div>
