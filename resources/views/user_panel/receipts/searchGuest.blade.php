            ...
            <div id="consult-receipt" class="col-lg-9">
                <div class="card text-center">
                    ...
                    <div class="card-block text-center">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <table style="margin: 0 auto;margin-bottom:15px">
                                                    <tr>
                                                        <td> <input title="Unicamente valores numéricos están permitidos"
                                                                type="number"
                                                                style="font-size: 2em;border-radius: 3px;margin: 0 7px; border: none;background-color: #e4e4e4;height: 35px;width:4em;padding-left: .5em;"
                                                                class="inputs_contrato" name="contract" id="contract"
                                                                data-parsley-required="true" /></td>
                                                        <td style="font-size: 2em;">
                                                            -
                                                        </td>
                                                        <td>
                                                            <input title="Unicamente valores numéricos están permitidos"
                                                                type="number" class=" inputs_contrato" name="contract2"
                                                                id="contract2" data-parsley-required="true"
                                                                style="font-size: 2em;border-radius: 5px; margin: 0 7px; border: none;background-color: #e4e4e4;height: 35px;width:4em;padding-left: .5em;" />
                                                        </td>
                                                        <td style="font-size: 2em;">
                                                            -
                                                        </td>
                                                        <td>
                                                            <input title="Unicamente valores numéricos están permitidos"
                                                                type="number" class="inputs_contrato" name="contract3"
                                                                id="contract3" data-parsley-required="true"
                                                                style="font-size: 2em;border-radius: 5px;margin: 0 7px; border: none;background-color: #e4e4e4;height: 35px;width:4em;padding-left: .5em;" />
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <button type="submit" id="receiptSearch" style="cursor: pointer" class="boton_mostrar2 btn btn-lg "
                            data-route="{!! route("receipts.consult") !!}"> Consultar recibo</button>
                    </div>
